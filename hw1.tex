...
\begin{proof}
	...
	%From (\ref{trig_ident_cos}) we can see that the discontinuity for $\cos\left(\frac{N}{2}t \right)\cot \left( \frac{1}{2}t \right)$ will vanish in a similar fashion to above. 
